...
\begin{my_list}
\item  Kaggle Malware Competition models and compared to models in the\\ \tab \tab CyberPoint Machine Learning Model Training Pipeline.
...
\textsc{Publications}\\
\begin{publications}
\item John Seymour and Charles Nicholas, ``How to build a malware classifier [that doesn’t suck on real-world data]'', SecTor, October 2016.
\item John Seymour and Charles Nicholas, ``How to build a malware classifier [that doesn’t suck on real-world data]'', Data Science MD Meetup, October 2016.
\item BBC Tech Article?
\item the Atlantic Article?
\item John Seymour and Philip Tully, ``Weaponizing Data Science for Social Engineering: Automated E2E Spear Phishing on Twitter'', DEF CON 24, August 2016.
\item John Seymour and Philip Tully, ``Weaponizing Data Science for Social Engineering: Automated E2E Spear Phishing on Twitter'', Black Hat USA, August 2016.
\item John Seymour and Charles Nicholas, ``Labeling the VirusShare Corpus: Lessons Learned'', BSidesLV, August 2016.
\item John Seymour and Charles Nicholas, ``Labeling the VirusShare Corpus: Lessons Learned'', SPARSA South, July 2016.
\item John Seymour and Philip Tully, ``Weaponizing Data Science for Social Engineering: Automated E2E Spear Phishing on Twitter'', BaltimorePython Meetup, July 2016.
\item Forbes article?
\item John Seymour and Charles Nicholas, ``Labeling the VirusShare Corpus: Lessons Learned'', BaltimorePython Meetup, June 2016.
...
\item John Seymour and Charles Nicholas, ``Quantum'' Classification of Malware, DEF CON 23, August 2015.
\item John Seymour and Charles Nicholas, ``Quantum'' Classification of Malware, CyberPoint International, July 2015.
\item John Seymour and Charles Nicholas, ``Quantum'' Classification of Malware, UMBC DREAM Lab, July 2015.
\item John Seymour and Charles Nicholas, Overgeneralization in Malware Classification, CyberPoint International, July 2015.
\item John Seymour and Charles Nicholas, ``Overgeneralization in Malware Classification'', Malware Technical Exchange Meeting, June 2015. (poster session)
\item John Seymour, ``Overgeneralization in Feature Set Selection for Classification of Malware'', CSEE Technical Report TR-CS-14-06, August 2014.
...
\medskip
\textsc{Affiliations}\\
\atab Admin for Baltimore Python
\atab SPARSA South
\atab MD Data Science
\atab Technical Consultant for the UMBC Ethics Bowl Team [link]
\atab Judge for Code SLAM [link]
\end{document}