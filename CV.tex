...
\medskip
\begin{tabular}{l l}
Baltimore Python & Code SLAM: Python for Kids\\
Cold Weather Shelter (CMPC) & Eagle Scout\\
MD Data Science & MLSecProject\\
SPARSA South & UMBC Ethics Bowl Team\\
UMBC Honors College Alumn & United States Fencing Association\\
\end{tabular}
\end{document}